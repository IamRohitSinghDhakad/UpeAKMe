...
class MessageConstant: NSObject {
    ...
    static let BlankEmail: String = "Enter Email Address"
    static let BlankFirstName: String = "Enter First Name"
    static let BlankLastName: String = "Enter Last Name"
    ...
    static let BlankPhoneNo: String = "Enter Mobile Number"
    ...
    static let BlankPassword: String = "Enter Password"
    ...
    static let PWDMustContain: String = "Password Length must be 6"
